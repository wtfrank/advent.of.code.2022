...
impl std::fmt::Display for Monke{
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        ...
        write!(f, "has: {}. {}{}{}. Test:{} ? {} : {}", starting_items, self.operation.0, self.operation.1, self.operation.2, self.test_divisor, self.success_monke, self.failure_monke)
    }
}
